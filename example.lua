...
do 
    local CombatPage = Window:Page({Name = "Aimbot", SubPages = true})
    local PlayerPage = Window:Page({Name = "Visuals", Columns = 2})
    local VisualsPage = Window:Page({Name = "Movement", Columns = 2})
    local PlayersPage = Window:Page({Name = "Misc", Columns = 2})
