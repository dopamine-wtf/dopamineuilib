-- LOADING SCREEN (Blocks menu until animation completes)
local LoadingScreen = {}
do
    ...
    -- Full screen background (50% transparent black)
    -- Using Scale = 2 so it covers MORE than the screen can hold
    local Background = Instance.new("Frame")
    Background.Name = "Background"
    Background.Size = UDim2.new(2, 0, 2, 0) -- 2x screen size
    Background.Position = UDim2.new(-0.5, 0, -0.5, 0) -- Centered
    Background.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Background.BackgroundTransparency = 0.5 -- 50% transparent
    ...
    LoadingText.Size = UDim2.new(0, 300, 0, 80)
    LoadingText.Position = UDim2.new(0.5, -150, 0.5, -40)
    LoadingText.AnchorPoint = Vector2.new(0.5, 0.5)
    LoadingText.BackgroundTransparency = 1
    LoadingText.BorderSizePixel = 0
    LoadingText.Text = "Loading..."
    LoadingText.TextColor3 = Color3.fromRGB(0, 191, 255) -- #00BFFF
    ...
    -- Function to run the loading animation (blocks until complete)
    function LoadingScreen:WaitForAnimation()
        -- Fade IN (Background and Text together)
        local FadeInBG = TweenService:Create(Background, 
            TweenInfo.new(0.7, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
            {BackgroundTransparency = 0.5}
        )
        local FadeInText = TweenService:Create(LoadingText,
            TweenInfo.new(0.7, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
            {TextTransparency = 0}
        )
        ...
        FadeInBG:Play()
        FadeInText:Play()
        FadeInText.Completed:Wait() -- Wait for fade in to complete
        
        -- Brief pause at full visibility
        task.wait(0.3)
        
        -- Fade OUT (Background and Text together)
        local FadeOutBG = TweenService:Create(Background,
            TweenInfo.new(0.7, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
            {BackgroundTransparency = 1}
        )
        local FadeOutText = TweenService:Create(LoadingText,
            TweenInfo.new(0.7, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
            {TextTransparency = 1}
        )
        ...
        FadeOutBG:Play()
        FadeOutText:Play()
        FadeOutText.Completed:Wait() -- Wait for fade out to complete
    end
...
-- Run the loading animation and wait for it to COMPLETE before loading the menu
local AnimationComplete = false

coroutine.wrap(function()
    LoadingScreen:WaitForAnimation() -- This blocks until animation finishes
...
repeat
    task.wait()
until AnimationComplete == true

-- Remove the loading screen
LoadingScreen:Remove()

-- NOW the menu loads (your existing code starts here)
if Library then
    Library:Unload()
end
